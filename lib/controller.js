/**
 * This module controls the handling of command-line arguments
 */
...
var controller = (function() {
  ...
  var _get = function(argv) {
    ...
    // Lookup table for option abbreviations
    var _abbrLut = {
      p: 'props',
      s: 'structs',
      e: 'elems',
    ...
    // Pack all options in _abbrLut into _options object
    var _options = {};
    for(var abbr in _abbrLut) {
      var option = _abbrLut[abbr];
      _options[option] = argv[abbr] || argv[option];
    }
